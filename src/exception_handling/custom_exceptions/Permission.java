...
public class Permission {
    /*
    Create a method isAgeValid, takes an int as an arg
    It returns true if the age is more than 16
    Otherwise trows an IllegalStateException with "Age of {age} is restricted!!!"
     */
 ...
 */
    ...
    public static String getCheckInHours(int day){
        if(day > 1 && day < 7 ) return "Check in hours are from 10 AM to 5 PM";
