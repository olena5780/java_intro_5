...
public class CurrentDate {
    public static void main(String[] args) {
        ...
        System.out.println(localDate.plusDays(7)); //2002-12-18
        ...
        System.out.println(localTime); //11:18:44.160 hh:mm:ss.SSS
        System.out.println(localTime.minus(2, ChronoUnit.HOURS));

        System.out.println("\n-----------------LocalDateTime class-----------------\n");
        LocalDateTime localDateTime =  LocalDateTime.now();
        System.out.println(localDateTime); //2022-12-11T11:22:45.781
